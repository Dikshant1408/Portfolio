...
const blogPosts = [
  {
    id: '1',
    title: 'Building AI-Powered Applications: Lessons from CelestAI',
    excerpt: 'Insights from developing an AI chatbot for space exploration, including challenges in natural language processing and domain-specific knowledge integration.',
    date: '2025-01-15',
    readTime: '8 min read',
    tags: ['AI', 'Machine Learning', 'Chatbot', 'Space Technology'],
    slug: 'building-ai-powered-applications-celestai',
    featured: true
  },
  {
    id: '2',
    title: 'Fintech Innovation: Market Research and User Experience',
    excerpt: 'How comprehensive market research and user feedback sessions can boost customer engagement by 25% in fintech products like DhanXpert.',
    date: '2024-12-20',
    readTime: '10 min read',
    tags: ['Fintech', 'Market Research', 'User Experience', 'Innovation'],
    slug: 'fintech-innovation-market-research',
    featured: true
  },
  {
    id: '3',
    title: 'From Campus Management to Space Health: Diverse Project Development',
    excerpt: 'Exploring the journey of developing projects across different domains - from campus management systems to space health assessment tools.',
    date: '2024-11-15',
    readTime: '6 min read',
    tags: ['Project Management', 'Software Development', 'Innovation'],
    slug: 'diverse-project-development-journey',
    featured: false
  },
  {
    id: '4',
    title: 'Machine Learning in Student Budget Management',
    excerpt: 'How AI algorithms can help students manage their finances effectively through intelligent expense tracking and spending insights.',
    date: '2024-10-25',
    readTime: '7 min read',
    tags: ['Machine Learning', 'AI', 'Student Life', 'Budget Management'],
    slug: 'machine-learning-student-budget-management',
    featured: false
  }
]
